...
class InsertRequest extends FormRequest
{
    ...
    {
        return [
            'name'          => 'required|min:3|max:25|string|unique:societies,name',
            ...
            'tel'           => 'required|string|min:10|max:10|unique:societies,tel',
            'speaker'       => 'required|min:3|max:25|string',
            'range'         => 'required|string',
            'turnover'      => 'required|min:3|max:25|string',
            'logo_beta'     => 'required|mimes:jpeg,bmp,png,jpg|unique:societies,logo',
            'cover_beta'    => 'required|mimes:jpeg,bmp,png,jpg|unique:societies,cover'
        ];
    }
}
