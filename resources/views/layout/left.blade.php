                ...
                <div class="category-content">
                    <div class="media">
                        <a href="#" class="media-left">
                            @if(isset($user) and !empty($user->profil))
                                <img src="{{ asset($user->profil) }}" class="img-circle img-lg" alt=""/>
                            @else
                                <img src="{{asset('uploads/images/profil/profil.png')}}" class="img-circle img-lg"
                                     alt=""/>
                            @endif
                        </a>
            ...
            <div class="sidebar-category sidebar-category-visible">
                <div class="category-content no-padding">
                    <ul class="navigation navigation-main navigation-accordion">
                        ...
                        <li><a href="#"><i class="icon-home4 text-warning-700"></i> <span>Dashboard</span></a></li>
                        <li><a href="#"><i class="icon-calendar text-warning-700"></i> <span>Calendrier</span></a></li>
                        <li><a href="#"><i class="icon-stats-growth text-warning-700"></i> <span>Statistiques</span></a>
                        </li>
                        ...
                        <li><a href="#"><i class="icon-stack-check text-warning-700"></i> <span>Comptabilité</span></a>
                        </li>
                        <li><a href="#"><i class="icon-coins text-warning-700"></i> <span>Boutique</span></a></li>
                        <li><a href="#"><i class="icon-comment-discussion text-warning-700"></i>
