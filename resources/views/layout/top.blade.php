    ...
    @guest
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('home')}}">
                <img src="{{asset('uploads/images/logo_demo.png')}}" alt="logo">
            </a>
                        ...
                        @else
                            <li>
                                <a href="#" data-lang="ar" class="text-right">
                                    <img src="{{asset('uploads/images/flags/ar.png')}}" alt="">
                                    العربية</a>
                            </li>
                        @endif
                    </ul>
        ...
        @else
            <div class="navbar-header">
                <a class="navbar-brand" href="{{route('home')}}">
                    <img src="{{asset('uploads/images/logo_light.png')}}" alt="logo">
                </a>
                <ul class="nav navbar-nav visible-xs-block">
                    <li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-tree5"></i></a></li>
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            @if(isset($user) and !empty($user->profil))
                                <img src="{{ asset($user->profil) }}" alt=""/>
                            @else
                                <img src="{{asset('uploads/images/profil/profil.png')}}" alt=""/>
                            @endif
                            <span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a href="{{route('profil.show',['id'=>$user->id])}}" data-navigation="true" data-title="@if(isset($user)) {{$user->name}} @else 'Profil' @endif">
